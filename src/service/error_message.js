let errorCodes = new (function () {
  ...
  this.err_customer_record_106 = "ed (Target Effective Date): Must be a calendar date (in 'mm/dd/yy' form). Must be a date in the future but within the industry-set time period from current date, except for Resend action.";
  ...
  this.err_template_query_106 = "ed (Target Effective Date): Must be a calendar date (in 'mm/dd/yy' form). Must be a date in the future but within the industry-set time period from current date, except for Resend action.";

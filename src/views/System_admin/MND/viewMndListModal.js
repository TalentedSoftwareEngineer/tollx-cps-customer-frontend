...
import {
  Button, Card, Col, Input, Label, Modal, ModalHeader, ModalBody,  FormGroup,
} from "reactstrap";
...
class ViewMndListModal extends Component {
  static propTypes = {
   ...
   * */
  download = () => {
    this.downloadForm.action = Config.apiEndPoint + "/somos/automation/result/filterview/download?id=" + this.props.data.id + "&status=" + this.state.status + "&mnpType=MND"
...
export default withAuthApiLoadingNotification(ViewMndListModal)

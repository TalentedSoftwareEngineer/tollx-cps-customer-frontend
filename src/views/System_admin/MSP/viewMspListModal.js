...
class ViewMspListModal extends Component {
  static propTypes = {
  ...
  constructor(props) {
    ...
    console.log("meta id: " + this.props.data.metaId);
  }
  ...
  numberListColumn = [
    {
      ...
      Cell: props => <div className="text-center" style={{marginTop: 10}}>{formattedNumber(props.value)}</div>
    },
    {
      Header: "Result",
      accessor: 'status',
...
export default withAuthApiLoadingNotification(ViewMspListModal)
